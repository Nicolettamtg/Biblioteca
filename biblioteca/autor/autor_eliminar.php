...
$sentencia = $conexion->prepare("DELETE FROM autor WHERE id_autor = ?;");
...
<body>
    <div id="mensaje">
        ...
        <?php if ($resultado === TRUE) { ?>
            <button class="boton1" onclick="window.location.href='./autor_listado.php'">Volver a la lista</button>
        <?php } ?>
    </div>
</body>
